...
async function query() {
  // const books = await axios.get('https://s3.amazonaws.com/sundaysky-mock/books/listOfBooks.json')
  const books = await _getBooks()["books"]
  return books
}
...
//   const book = await httpService.get(`book/${bookId}`)
//   return book
// }

// async function saveBook(bookToSave) {
//   if (bookToSave._id) {
//     const savedBook = await httpService.put(`book/${bookToSave._id}`, bookToSave);
//     return savedBook
//   } else {
//     const addedBook = await httpService.post('book/', bookToSave);

//     return addedBook
//   }
// }

// async function updateBookTitle(book) {
//   await saveBook(book)
